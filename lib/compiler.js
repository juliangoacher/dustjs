...
dust.nodes = {
  ...
  "+": function(context, node) {
    if(typeof(node[1].text) === "undefined"  && typeof(node[5]) === "undefined"){
      ...
      + dust.compileNode(context, node[5]) + "," // INFU edit
      + dust.compileNode(context, node[3])
      + ")";
    }
  },
  ...
  "@": function(context, node) {
    return ".helper("
      + escape(node[1].text)
      + "," + dust.compileNode(context, node[2]) + ","
      + dust.compileNode(context, node[5]) + ","
      + dust.compileNode(context, node[3]) + ","
      + "[name," + node[4][1] + "," + node[4][2] + "]"
      + ")";
  },
